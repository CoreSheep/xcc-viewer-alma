...
function loadFileAnShowOnlyHeader()
{
   //setEmptyTabs();
    ...
    var e = document.getElementById("xseldoc");
    var value = e.value;
...
function getEditionTitel()
{
    let editionTitle = document.querySelector("title");

    if(editionTitle){
        $("#edition-titel").html( "<h3>" + editionTitle.innerHTML + "</h3>" );
    } else {
        $("#edition-titel").html("");
    }
}
...
function loadFile()
{
    ...
    var e = document.getElementById("xseldoc");  //get the selector
...
$("document").ready(function () {
    ...
    //-----------------------------------------------
        ...
        $("#xedithtml").on("click", '._witDetail', function(){
            ...
            let witDetailText = $(this).data("noteText");
